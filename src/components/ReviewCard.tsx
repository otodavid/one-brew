...
export const ReviewCard = () => {
  return (
    <div className='relative bg-white rounded-xl px-4 py-8 shadow-lg'>
      <div className='w-16 h-16 rounded-full absolute overflow-hidden -top-8 left-2/4 -translate-x-2/4'>
        <Image
          src='https://cloudflare-ipfs.com/ipfs/Qmd3W5DuhgHirLHGVixi6V76LhCkZUz6pnFt5AJBiyvHye/avatar/674.jpg'
      ...
      <p className='font-semibold text-center'>Ophelia Ritchie</p>
