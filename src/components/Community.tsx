...
const Card = ({ icon, heading, description }: CardProps) => {
  return (
    <div className='grid grid-cols-[auto_1fr] items-center gap-4 group'>
      <div className='w-20 h-20 text-4xl rounded-full self-center flex justify-center items-center text-accent bg-[#F0E7E4] group-hover:bg-primary group-hover:text-neutral-white'>
        {icon}
      </div>
      <div>
