...
const formSchema = z.object({
  ...
  phone: z
    .number({ required_error: 'Email is required.' })
    .min(1, { message: 'please input a valid number' }),
  country: z.string({ required_error: 'Please enter a country.' }),
  state: z.string({ required_error: 'Please enter a province/state.' }),
  city: z.string({ required_error: 'Please enter a city.' }),
  postalCode: z.string({ required_error: 'Please enter a postal/zip.' }),
});
